...
This guide describes the preserved `search-experimental` command and problem schemas 1–6. For the lazy native graph/equipment search using problem schemas 7–10, see [passive/equipment assembly](passive-equipment-assembly.md).
...
It loads the [schema-10 game-data package](native-data.md#schema-migration) once and shares
