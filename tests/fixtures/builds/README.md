...
parity: no PoB runtime has evaluated this fixture. In particular, all Full DPS
...
The XML is untrusted imported data. Future readers must bound decoding and XML
size, reject DTD/entity expansion, preserve unknown fields, and never execute
