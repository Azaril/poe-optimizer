    ...
    IDENTITY
        .get_or_init(|| {
            ...
            for text in [
                ...
                include_str!("../../poe-optimizer-engine/src/timing/legacy.rs"),
                include_str!("../../poe-optimizer-engine/src/timing/ordinary.rs"),
                ...
                include_str!("../../poe-optimizer-engine/src/resistance/legacy.rs"),
                include_str!("../../poe-optimizer-engine/src/resistance/ordinary.rs"),
                ...
                include_str!("../../poe-optimizer-import/src/build_source.rs"),
                include_str!("../../poe-optimizer-import/src/root_admission.rs"),
