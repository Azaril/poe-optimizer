...
pub(crate) fn extractor_sha256() -> String {
    ...
    for text in [
        ...
        include_str!("item_assembly_extract/inventory_activation.rs"),
        include_str!("item_assembly_extract/inventory/node_validity.rs"),
        ...
        include_str!("source_programs/capture/constructors.rs"),
        include_str!("source_programs/capture/constructors/diagnostic.rs"),
        include_str!("source_programs/capture/closures.rs"),
        ...
        include_str!("source_programs/constructors/diagnostic.rs"),
        include_str!("source_programs/constructors/reserved.rs"),
        ...
        include_str!("source_programs/capture/session.rs"),
        include_str!("source_programs/capture/session/classes.rs"),
        include_str!("source_programs/capture/session/classes/ownership.rs"),
        include_str!("source_programs/capture/session/discovery.rs"),
        include_str!("source_programs/capture/session/discovery/arena.rs"),
        include_str!("source_programs/capture/classes.rs"),
        include_str!("source_programs/capture/classes/prepared.rs"),
        include_str!("source_programs/capture/classes/protocol.rs"),
        ...
        include_str!("source_programs/syntax/closures.rs"),
